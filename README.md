...
- `4_partimatrix` : this folder contains the output files of the PartiMatrix analysis. Files ranging between `[01-13]_Apis_m_mtDNA_NA_[gene].pdf` are output of the genewise matrix. The matrix of `Apis_m_mtDNA_NA_subset_12.pdf` are of codon 1 and 2 and `Apis_m_mtDNA_NA_subset_3.pdf` are of codon 3.
